...
Dys X160 is a nice quadcopter which has an issue with drifting (mostly to the right, but some users report drifting to the left) in self-leveling mode. I had a deeper look into this behavior and collected evidence that this is a hardware design issue, which cannot be fixed by PID tuning and such.
...
Here's the data I collected. (*TODO link to raw file*)
...
Given that there is strong evidence that accelerometer in Dys X160 drifts from real director as a function of motors engagement, I tend to suggest hardware design issue. Most probably vibration from motors interfere with accelerometer work in consistent way.
